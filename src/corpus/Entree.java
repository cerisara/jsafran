...
public class Entree implements Serializable, Comparable<Entree>, DicoEntry {
    ...
    class Syntax implements Serializable, Comparable<Syntax> {
        ...
        corpus.DicoEntry.POStag postag = corpus.DicoEntry.POStag.UNK;
        corpus.DicoEntry.Genre genre = corpus.DicoEntry.Genre.UNK;
        corpus.DicoEntry.Nombre nombre = corpus.DicoEntry.Nombre.UNK, nombre2 = corpus.DicoEntry.Nombre.UNK;
        corpus.DicoEntry.Personne pers = corpus.DicoEntry.Personne.UNK;
        corpus.DicoEntry.Temps temps = corpus.DicoEntry.Temps.UNK;
        corpus.DicoEntry.Mode mode = corpus.DicoEntry.Mode.UNK;
     ...
     * @param tag
     */
    public void setPOStag(corpus.DicoEntry.POStag tag) {
        syntax.postag = tag;
    }
    ...
    public void setGenre(corpus.DicoEntry.Genre g) {
        syntax.genre = g;
    }

    public void setNombre(corpus.DicoEntry.Nombre n) {
        syntax.nombre = n;
    }
     ...
     * @param n
     */
    public void setNombre2(corpus.DicoEntry.Nombre n) {
        syntax.nombre2 = n;
    }

    public void setPersonne(corpus.DicoEntry.Personne p) {
        syntax.pers = p;
    }

    public void setTemps(corpus.DicoEntry.Temps t) {
        syntax.temps = t;
    }

    public void setMode(corpus.DicoEntry.Mode m) {
        syntax.mode = m;
    }
